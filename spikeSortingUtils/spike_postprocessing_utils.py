...
def retain_cluster_info(probe,group,p,mainPath):
    """
    ...
    #path_kwik_file = p['mainpath'] + '/analysis_files/probe_{:g}_group_{:g}/probe_{:g}_group_{:g}.kwik'.format(probe,group,probe,group)
    path_kwik_file = mainPath + '/analysis_files/probe_{:g}_group_{:g}/probe_{:g}_group_{:g}.kwik'.format(probe,group,probe,group) #path to the kwik file
    ...
    #path_clu_file = p['mainpath'] + '/analysis_files/probe_{:g}_group_{:g}/probe_{:g}_group_{:g}.clu.0'.format(probe,group,probe,group)
    path_clu_file = mainPath + '/analysis_files/probe_{:g}_group_{:g}/probe_{:g}_group_{:g}.clu.0'.format(probe,group,probe,group) #accessing the file where the clustering information is stored
    ...
    #raw_data = np.fromfile(p['mainpath'] + '/analysis_files/probe_{:g}_group_{:g}/probe_{:g}_group_{:g}.dat'.format(probe,group,probe,group),dtype='int16')
    raw_data = np.fromfile(mainPath + '/analysis_files/probe_{:g}_group_{:g}/probe_{:g}_group_{:g}.dat'.format(probe,group,probe,group),dtype='int16') #reading out the raw data file
    ...
    path_pickle_file = mainPath + '/analysis_files/probe_{:g}_group_{:g}/probe_{:g}_group_{:g}_spikeinfo.pickle'.format(probe,group,probe,group)
