"""
    This function removes the raw and the intermediate data files that are created and required for initial analyses.
...
def cleanup_data(main_path, keep_spike_info):
    ...
    print("\nRaw data and intermediate files are removed succesfully.")
